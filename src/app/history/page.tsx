    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        ...
        <div className="rounded-[1.75rem] border border-border bg-card p-6">
          <p className="text-sm uppercase tracking-[0.18em] text-primary">Summary</p>
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <div>
              <p className="text-sm text-muted-foreground">Average score</p>
              <p className="text-3xl font-semibold">{history.summary.averageScore ?? "—"}</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Completed sessions</p>
              <p className="text-3xl font-semibold">{history.summary.completedSessions}</p>
            </div>
          </div>
        </div>
      </div>
